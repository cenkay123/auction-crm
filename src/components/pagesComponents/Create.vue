<template>
  <v-card>
    ...
    <v-form v-model="loginForm.valid" class="px-10 pt-2">
      <v-row>
        <v-col cols="6">
          <v-text-field class="flag-TR"
                        ref="name"
                        v-model="name"
                        :rules="[() => !!name || 'This field is required']"
                        label="Baslik TR"
                        prepend-icon="mdi-flag-checkered"
                        placeholder="Turkce baslik giriniz"
                        required
                        outlined
          ></v-text-field>
        </v-col>
        <v-col cols="6">
          <v-text-field class="flag-EN"
                        ref="name"
                        v-model="name"
                        :rules="[() => !!name || 'This field is required']"
                        label="Baslik EN"
                        prepend-icon="mdi-flag-checkered"
                        placeholder="Ingilizce baslik giriniz"
                        required
                        outlined
          ></v-text-field>
        </v-col>
        <v-col cols="6">
          <v-combobox class="flag-TR"
                      ref="name"
                      v-model="model"
                      :rules="[() => !!model || 'This field is required']"
                      label="Keywords TR"
                      prepend-icon="mdi-flag-checkered"
                      placeholder="Turkce keywords giriniz"
                      required
                      multiple
                      small-chips
                      hide-selected
        ...
        <v-col cols="6">
          <v-combobox class="flag-EN"
                      ref="name"
                      v-model="modelEN"
                      :rules="[() => !!modelEN || 'This field is required']"
                      label="Keywords TR"
                      prepend-icon="mdi-flag-checkered"
                      placeholder="Turkce keywords giriniz"
                      required
        ...
        <v-col cols="6">
          <v-textarea class="flag-TR"
                      counter
                      v-model="name"
                      :rules="[() => !!name || 'This field is required']"
                      label="Ozet TR"
                      prepend-icon="mdi-flag-checkered"
                      placeholder="Turkce ozet giriniz"
                      required
                      outlined
          ></v-textarea>
        </v-col>
        <v-col cols="6">
          <v-textarea class="flag-EN"
                      counter
                      v-model="name"
                      :rules="[() => !!name || 'This field is required']"
                      label="Ozet TR"
                      prepend-icon="mdi-flag-checkered"
                      placeholder="Ingilizce ozet giriniz"
                      required
                      outlined
          ></v-textarea>
        </v-col>
        ...
        <v-col cols="6">
          <label class="custom-label flag-TR">Icerik TR &nbsp;<v-icon>mdi-flag-checkered</v-icon>
          </label>
          <ckeditor :editor="editor" v-model="data"></ckeditor>
        </v-col>
        <v-col cols="6">
          <label class="custom-label flag-EN">Icerik EN &nbsp;<v-icon>mdi-flag-checkered</v-icon>
          </label>
          <ckeditor :editor="editor" v-model="data"></ckeditor>
        </v-col>
