  ...
  <v-card>
    ...
    <v-form class="px-4 px-md-10 pt-2">
      <v-row>
        <v-col cols="12">
          <v-row>
            <v-text-field ref="name" v-model="sergiData['title_' + item.code]"
        ...
        <v-col cols="12">
          <v-row>
            <v-textarea counter v-model="sergiData['ShortDescription_' + item.code]"
        ...
        <v-col cols="12">
          <div v-for="item in $store.state.form.languages" :key="item.id">
            ...
            <Editor :data="sergiData" dataItem="LongDescription_" class="mt-3 mb-4" :lang="item"></Editor>
          </div>
        </v-col>
        <v-col cols="12">
